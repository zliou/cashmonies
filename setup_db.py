...
user1.items.append(Item({'name': 'Starbucks Gift Card', 'price':40}))
user1.items.append(Item({'name': 'Costco Gift Card', 'price':20}))

user2.items.append(Item({'name': 'Target Gift Card', 'price':25}))
